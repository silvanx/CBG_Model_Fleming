...
from pyNN.neuron import Population, StepCurrentSource, SpikeSourceArray,\
    Projection, StaticSynapse, FromFileConnector, NoisyCurrentSource,\
...
def create_network(Pop_size, steady_state_duration, simulation_duration,
    ...
    np.savetxt('cortical_xy_pos.txt', Cortical_Pop.positions,
               delimiter=',')
    ...
    prj_CorticalSTN.saveConnections(
        file="CorticalSTN_Connections.txt")
    prj_STNGPe.saveConnections(
        file="STNGPe_Connections.txt")
    prj_GPeGPe.saveConnections(
        file="GPeGPe_Connections.txt")
    prj_GPeSTN.saveConnections(
        file="GPeSTN_Connections.txt")
    prj_StriatalGPe.saveConnections(
        file="StriatalGPe_Connections.txt")
    prj_STNGPi.saveConnections(
        file="STNGPi_Connections.txt")
    prj_GPeGPi.saveConnections(
        file="GPeGPi_Connections.txt")
    prj_GPiThalamic.saveConnections(
        file="GPiThalamic_Connections.txt")
    prj_ThalamicCortical.saveConnections(
        file="ThalamicCorticalSoma_Connections.txt")
    prj_CorticalThalamic.saveConnections(
        file="CorticalSomaThalamic_Connections.txt")
